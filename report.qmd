...
![Research structure – detailed flow chart, version 27. 5. (open image in new tab to see in full).](pdf/ResearchStructure_20250610.pdf){height="100%" width="100%" src="path-to-pdf"}
...
![Map of ÚSES within our area - placeholder](/img/placeholder.png)

##### Aggregation and normalisation

Values were assigned based on the level of connectivity to ÚSES. Highest value was assigned to polygins intersecting with ÚSES elements, polygons that are connected by continuous green land cover (as defined in Land Cover general type of landcover) were also assigned a slight priority.
...
![Map of Ecological quality improvement potential - placeholder](/img/placeholder.png)
...
![Map of values for MCDA - placeholder](/img/placeholder.png)
...
##### Soil retention abilityand permeability
