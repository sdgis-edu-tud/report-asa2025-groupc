...
__*How to approach stream restoration so that it gives place for desired urban and community facilities, as well as improving biodiversity, ecological connectivity, and water retention in the landscape?*__
...
![Research structure – detailed flow chart, version for midterm (open image in new tab to see in full). Climate adaptation might change to include shadow/temperature , biodiversity might include NDVI.](/img/ResearchStructure_20250525.png)
...
<!--# intro -->
__*how to improve local and supra local biodiversity resilience by interventions within the stream flood plain? -> which spaces to prioritize based on value and feasibility of intervention*__
...
![WIP landcover overview](/img/B_LandCover_old.png)

![Typical examples of landcover classes, draft estimate ecological quality indicator](/img/B_LandCover_typology.png)

#### #3 ? + some other indicator– maybe we do not need it, because the other ones are good enough together? – NDVI???
...
### Climate adaptation
__*how to use areas in the flood plain to capture water in the landscape? -> where is good space for infiltration basins and natural flood protection measures based on soil types and flood risk?*__
...
__*what type of places should be created in the stream flood plain?*__ -\> amenities, green spaces, connections / what combination
